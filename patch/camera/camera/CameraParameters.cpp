...
const char CameraParameters::CAMNOTE_BL_B[] = "black-b";
const char CameraParameters::CAMNOTE_WB_B[] = "white-b";
const char CameraParameters::CAMNOTE_WB_C[] = "white-c";
const char CameraParameters::CAMNOTE_OFF[] = "off";
const char CameraParameters::CAMNOTE_NORMAL[] = "normal";	
const char CameraParameters::KEY_CAMNOTE_MODE[] = "pantech-camnote-mode";
const char CameraParameters::KEY_CAMNOTE[] = "pantech-camnote";
...
const char CameraParameters::KEY_WDR_MODE[] = "pantech-wdr-mode";
...
const char CameraParameters::KEY_SKY_IPL_VALUE_1[] = "pantech-ipl-value_1";
const char CameraParameters::KEY_SKY_IPL_VALUE_2[] = "pantech-ipl-value_2";
const char CameraParameters::SKY_IPL_CARTOON_FRONT[] = "pantech-ipl-cartoon-front";	
...
const char CameraParameters::KEY_SUPPORTED_WDR_MODE[] = "pantech-wdr-mode-values";
...
const char CameraParameters::KEY_SUPPORTED_CAF_CAMERA[] = "pantech-caf-camera-values";
const char CameraParameters::KEY_SUPPORTED_FACE_FILTER[] = "pantech-face-filter-values";
const char CameraParameters::KEY_CAF_CAMERA[] = "pantech-caf-camera";
const char CameraParameters::CAF_CAMERA_ON[] = "on";
const char CameraParameters::CAF_CAMERA_OFF[] = "off";	
...
const char CameraParameters::IS_SYHOST[] = "syhost";


int CameraParameters::isSyhost()
{
    const char *p = get(IS_SYHOST);
    if((p[0] == 's') && (p[4] == 's'))
        return 1;
    else 
        return 0;
