...
public:
   ...
   //    static const char HDR_DISABLE[];
    ...
    static const char KEY_SUPPORTED_WDR_MODE[];
    static const char KEY_SUPPORTED_ANTISHAKE[];
    static const char KEY_SUPPORTED_MULTISHOT[];
    static const char KEY_SUPPORTED_CAF_CAMERA[];
    static const char KEY_SUPPORTED_FACE_FILTER[];
    static const char KEY_CAF_CAMERA[];
    static const char CAF_CAMERA_ON[];
    static const char CAF_CAMERA_OFF[];	
